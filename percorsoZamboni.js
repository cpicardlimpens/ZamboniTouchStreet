    ...
    $.getJSON( "features.json", function( data ) {
        ...
        for (var i = 1; i <= features.length; i++) {
            $('#modals').append('<div class="modal fade" id="myModal_' + i + '" role="dialog">' +
                ...
                '<iframe id="videoContent" width="560" height="315" src="https://www.youtube.com/embed/em5PRRO-sK0" frameborder="0" allowfullscreen></iframe>' + //video could a feature!!
        ...
        $('#modals').append('<div class="modal fade" id="myModal" role="dialog">' +
            ...
            '</div>' +
            '<div class="modal-body">' +
            '<iframe id="videoContent" width="560" height="315" src="https://www.youtube.com/embed/6ju8xO_Zvfo" frameborder="0" allowfullscreen></iframe>' + //video could a feature!!
            '</div>' +
            '<div class="modal-footer">' +
            '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>' +
            '</div>' +
